        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-16 pt-18 mb-32">
            ...
            <div class="w-full lg:flex-1 lg:max-w-md">
                <div class="relative h-full">
                    <x-card class="relative h-full bg-zinc-950 dark:bg-zinc-50 overflow-hidden">
                        <div class="relative space-y-8">
                            {{-- Header --}}
                            <div class="space-y-2">
                                <flux:text size="sm" class="font-medium !text-lime-400 dark:!text-lime-600">
                                    {{ __('Smile Point Dental Clinic') }}
                                </flux:text>
                                <flux:heading level="3" size="xl"
                                              class="tracking-tight !text-white dark:!text-zinc-900">
                                    {{ __('Get in Touch') }}
                                </flux:heading>
                                <flux:text class="!text-white/60 dark:!text-zinc-500">
                            ...
                            <div class="relative mt-2">
                                ...
                                <div class="relative p-4 rounded-2xl border border-white/10 dark:border-zinc-200">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex-1">
                                            <flux:text class="text-white! dark:text-zinc-800!" variant="strong">
                                                {{ __('Chat on Viber') }}
                                            </flux:text>
                                            <flux:text size="sm" class="dark:invert" variant="subtle">
