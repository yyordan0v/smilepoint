    ...
    <section class="isolate relative mt-64">
        <div class="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
                ...
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)] border border-blue-100">
                    ...
                    <div class="relative min-h-32 w-full grow max-lg:mx-auto max-lg:max-w-sm">
                        <div class="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-xl bg-gradient-to-b from-blue-100/50 to-indigo-100/50 border border-blue-200">
                            <img src="{{ asset('images/invisalign.png') }}" alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="relative max-lg:row-start-1">
                <x-card class="relative bg-zinc-50/30 border border-zinc-200">
                    <img src="{{ asset('images/social-icons/viber.png') }}" alt="Chat on Viber"
                         class="pointer-events-none absolute bottom-4 right-4 w-24 h-24 -z-1 opacity-70">
                    ...
                    <div class="space-y-4">
                        ...
                        <flux:button variant="filled" icon-trailing="paper-airplane">Send Message</flux:button>
                    </div>
                </x-card>
            </div>
